...
---
以前 "Wordpress の Textile プラグイン":http://nanataisan.net/blog/2009/08/02/wordpress-textile-plugin/ という記事で、Wordpress の Textile 対応について書きました。この時は満足の行く結果が得られませんでしたが、今回ついにまともに Textile 2 が使えるようにできました。
