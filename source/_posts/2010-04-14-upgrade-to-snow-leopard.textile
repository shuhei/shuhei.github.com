...
pre(prettyprint). $ sudo port install ruby19

このままだとコマンド名が @ruby1.9@ や @rake1.9@ です。
@ruby@ や @rake@ として使いたいので、シンボリックリンクを作成。

pre(prettyprint). $ cd /opt/local/bin
