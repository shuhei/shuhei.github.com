...
参考にしたのは "RubyのCursesを使ってコンソールを制御する（1/2）：CodeZine":http://codezine.jp/article/detail/2086 と "curses - Rubyリファレンスマニュアル":http://www.ruby-lang.org/ja/man/html/curses.html 。

pre(prettyprint).. require 'curses'
