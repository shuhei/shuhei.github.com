...
describe("highlight", () => {
  it("highlights code when a language is specified", () => {
    ...
    expect(highlight(js, "js")).toBe(
      '<pre><code class="hljs js"><span class="hljs-variable language_">console</span>.<span class="hljs-title function_">log</span>(<span class="hljs-string">&#x27;hello&#x27;</span>);</code></pre>'
    );
  });
