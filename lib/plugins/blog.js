...
const IndexPage = require("../layouts/IndexPage");
const ArchivesPage = require("../layouts/ArchivesPage");
const PostPage = require("../layouts/PostPage");
const PagePage = require("../layouts/PagePage");
...
function index(config) {
  ...
  async function renderTemplate(tmpl, dest, locals) {
    const templateFile = path.resolve(__dirname, "..", "layouts", tmpl);
